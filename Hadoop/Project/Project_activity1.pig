...
inputFile1 = LOAD 'hdfs:///user/anshul/inputs/episodeIV_dialogues.txt' USING PigStorage('\t') AS (Character:chararray, line:chararray);
inputFile2 = LOAD 'hdfs:///user/anshul/inputs/episodeV_dialogues.txt' USING PigStorage('\t') AS (Character:chararray, line:chararray);
inputFile3 = LOAD 'hdfs:///user/anshul/inputs/episodeVI_dialogues.txt' USING PigStorage('\t') AS (Character:chararray, line:chararray);
...
STORE cntd INTO 'hdfs:///user/anshul/ProjectPigOutput1';